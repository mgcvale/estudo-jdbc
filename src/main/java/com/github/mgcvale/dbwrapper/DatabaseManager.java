package com.github.mgcvale.dbwrapper;
...
public class DatabaseManager implements Cloneable {
    ...
    public LinkedHashMap<Object[], Object[]> getTable(String tableName,
        ...
        valueAmount = columnNames.length;
        keyAmount = pkNames.length;

        ps = con.prepareStatement(statement);
        result = ps.executeQuery();
        int index=0;
        while(result.next()) {
            Object[] keys = new Object[keyAmount > 0 ? keyAmount : 1];
            Object[] values = new Object[valueAmount];
    ...
    public void deleteFromTable(String tableName, String where) throws SQLException {
        deleteFromTable(tableName, where, false);
    }
    public void deleteFromTable(String tableName, String where, boolean resetAutoIncrement) throws SQLException {
        Connection con = getConnection();
